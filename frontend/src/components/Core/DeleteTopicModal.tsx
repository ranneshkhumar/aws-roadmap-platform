...
export default function DeleteTopicModal({ isOpen, topic, onClose, onSubmit }: DeleteTopicModalProps) {
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-500 font-semibold">{topic.name}</p>
          </div>
        </div>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 mb-5 text-xs font-semibold text-slate-600 space-y-1.5">
          ...
          <p>All modules inside this topic will also be deleted.</p>
        </div>
